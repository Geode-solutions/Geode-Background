<h1 align="center">Geode-BackgroundMesh<sup><i>by Geode-solutions</i></sup></h1>
<h3 align="center">Background meshing for Geode-solutions OpenGeode modules</h3>
...
Geode-BackgroundMesh is an [OpenGeode](https://github.com/Geode-solutions/OpenGeode) module providing tools for gathering meshes and models into an unique support, called a BackgroundMesh.
...
Installing Geode-BackgroundMesh is done by using pip command ```pip install Geode-BackgroundMesh``` and add ```import geode_backgroundmesh``` in your Python script.
